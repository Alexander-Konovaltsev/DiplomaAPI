...
from crud.model import get_models_by_scene_id, get_all_models_by_scene_id
...
def get_all_models_by_scene(scene_id: int, db: Session = Depends(get_db), user: dict = Depends(get_current_user)):
